...
class SideBar extends React.Component {
    ...
    render () {
        ...
        return (
            <div>
                {!redirect?
                    <Col xs={2} md={3} style={{backgroundColor:'purple',height:'100vh',color:'white'}}>
                        <Col xs={6} xsOffset={3}>
                            <br/>
                        ...
                        <Col xs={12} style={{backgroundColor:'purple'}}>
                            <ul style={{color:'white',fontSize:25}}>
                                ...
                                <li style={{listStyleType:'none',padding:10}}><Link to='/orders' style={{color:'white'}}>Tareas Completadas</Link></li>
